...
class edrone_gripper():
    ...
    def __init__(self):
        ...
        self.box_model_name_list = ['strawberry_box', 'strawberry_box_1', 'strawberry_box_2', 'strawberry_box_3', 'strawberry_box_4', 'strawberry_box_5', 'strawberry_box_6', 'strawberry_box_7', 'strawberry_box_8', 'strawberry_box_9', 'strawberry_box_10', 'strawberry_box_11', 'strawberry_box_12', 'strawberry_box_13', 'strawberry_box_14', 'strawberry_box_15', 'strawberry_box_16', 'strawberry_box_17', 'strawberry_box_18']
        self.drone_model_name = 'if750a'
        rospy.Subscriber('/gazebo/model_states_throttle', ModelStates, self.model_state_callback)
        self.check_pub = rospy.Publisher('/gripper_check', String, queue_size=1)
        self.gripper_service = rospy.Service('/activate_gripper', Gripper, self.callback_service_on_request)
